<x-sidebar>
    @section('title', __('Accepted Overtime Requests'))
    @push('head')
                                    ...
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div class="p-6 space-y-6">
                                            <div class="text-base leading-relaxed text-gray-500">
                                                {{ __('Are you sure you want to delete this overtime request') }}?
                ...
                @else
                    <tr class="border-gray-300">
                        <td colspan="4" class="px-4 py-8 border-t border-gray-300 text-lg">
                            <p class="text-center">{{ __('No Accepted Overtime Requests Found') }}</p>
                        </td>
                    </tr>
                @endunless
            </tbody>
